...
public class ImageDownloader {
    ...
    public static String FILE_WAY = "Z:\\MyWorkSpase\\ValentynTests\\FirstTests\\SecondTest\\Test_image.jpg";
    public static File IMAGE = new File("Z:\\MyWorkSpase\\ValentynTests\\FirstTests\\Test_image.jpg");

    public File saveImage(String url1 ,String fileWay) throws IOException {
        URL url = new URL(url1);
        try (InputStream in = url.openStream();
             OutputStream out = new FileOutputStream(FILE_WAY)) {
